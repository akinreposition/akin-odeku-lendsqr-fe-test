...
//   loggedStaffInitials: string | null;
//   onLogout: () => void;
// }
    ...
    <nav className="topbar">
      <div className="topbar-container">
        ...
        <div className="menu-side">
          ...
          <a href={'/#'} className="logout" title="Docs">
            <p>Docs</p>
          </a>
          <div className="logout" title="Notification">
            <p>
            ...
            <p><img src={avatar}  alt="logo" /></p>
            <p onClick={toggleDropdown}>
              Ayodeji
              {isOpen && <svg className="dropdown-icon" width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M5.99999 6L6.99999 7L5.99999 8" stroke="#213F7D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
              </svg>}
            </p>
            {isOpen && (
          ...
          {/* <div className="user-info">
            {loggedStaffInitials && <p>{loggedStaffInitials}</p>}
          </div> */}
        </div>
      </div>
    </nav>
